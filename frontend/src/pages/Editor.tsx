...
const Editor = () => {
  ...
  const [title, setTitle] = useState(isNewDocument ? "" : "Essay on Climate Change Policy");
  const [content, setContent] = useState(isNewDocument ? "" : "Climate change represents one of the most pressing challenges of our time...");
